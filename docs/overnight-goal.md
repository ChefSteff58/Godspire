...
- [ ] **shade** — "a Shade, small ghostly shadow wraith, tattered dark-purple cloak, glowing pale eyes, wispy translucent lower body, eerie". (small swarm unit)
- [ ] **harpy** — "a Harpy, winged bird-woman monster, large feathered wings, clawed talons, wild hair, fierce, airborne". (flying — engine already renders it above + a hint)
- [ ] **talos** — "Talos, a giant bronze automaton warrior, riveted bronze armor plates, single glowing eye, heavy, lumbering". (armored brute)
- [ ] **satyr** — "a Satyr, goat-legged man, furry goat legs and hooves, small curved horns, mischievous, holding a wooden club, quick". (fast)
- [ ] **gorgon** — "a Gorgon, snake-haired woman monster, writhing snakes for hair, scaled greenish skin, menacing glare, holding a short bow". (stealth — engine renders at half-alpha)
- [ ] **hydra** — 🚫-RISK NON-HUMANOID: "the Lernaean Hydra, a multi-headed green serpent dragon, several snake heads on long necks, scaled coiled body, venomous". No humanoid/quadruped template fits a serpent — try `mode:"pro"` humanoid as a best effort (or skip + log) and FLAG for the user's review. Do not burn many re-rolls on it.

### Bosses (v3 humanoid — both bipedal; anim = walk; a signature can come later)
- [ ] **minotaur** — "the Minotaur, a massive muscular bull-headed man, large horns, nose ring, wielding a huge double-bladed labrys axe, snorting, imposing".
- [ ] **cyclops** — "a Cyclops, a colossal one-eyed giant, one huge central eye, ragged loincloth, swinging a giant club, brutish, towering".
