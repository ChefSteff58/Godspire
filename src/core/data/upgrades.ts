  ...
  demeter: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Golden Fields', cost: 1300, desc: 'Fields of pure gold — +160 gold with every harvest.', effect: { incomePerWaveAdd: 160 } },
        { name: 'Elysian Harvest', cost: 3000, desc: 'The blessed fields of Elysium — +300 gold, wave after wave.', effect: { incomePerWaveAdd: 300 } },
      ],
    },
    B: {
      ...
      tiers: [
        ...
        { name: 'Compounding Empire', cost: 1400, desc: 'Wealth breeds wealth — +7×wave, and climbing.', effect: { incomeWaveScaleAdd: 7 } },
        { name: 'Hoard of Plutus', cost: 3200, desc: 'The god of riches empties his hoard — +12×wave, a late-game fortune.', effect: { incomeWaveScaleAdd: 12 } },
      ],
    },
  },
  hermes: {
