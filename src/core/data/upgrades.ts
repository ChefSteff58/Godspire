  ...
  zeus: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Herald of the Storm', cost: 1800, desc: 'The heavens open — a relentless barrage that blankets the field.', effect: { fireRateMul: 1.5, damageMul: 1.3, rangeMul: 1.15 } },
        { name: 'Lord of Olympus', cost: 6000, desc: 'Zeus unbound — the sky itself is his weapon, striking without pause.', effect: { fireRateMul: 1.6, damageMul: 1.6, rangeMul: 1.2 } },
      ],
    },
    B: {
      name: 'Tyrant',
      ...
      tiers: [
        ...
        { name: 'Skyfall', cost: 2400, desc: 'A pillar of heaven falls — colossal impacts that erase the mighty.', effect: { damageMul: 2.5, rangeMul: 1.2 } },
        { name: 'The First Thunder', cost: 8400, desc: 'Creation\'s own bolt — one strike is a legend, one wound is the end.', effect: { damageMul: 3, rangeMul: 1.3 } },
      ],
    },
  },
  apollo: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Daybreak Volley', cost: 2100, desc: 'Dawn breaks in a fan of light — pierces deeper and faster.', effect: { pierceAdd: 4, fireRateMul: 1.2 } },
        { name: 'Solar Cataclysm', cost: 6800, desc: 'The sun itself takes aim — a lance through the whole legion.', effect: { pierceAdd: 8, damageMul: 1.4 } },
      ],
    },
    B: {
      name: 'Plague-Ender',
      ...
      tiers: [
        ...
        { name: 'Pestilence', cost: 2200, desc: 'Sickness deepens to plague — devastating hits, loosed quicker.', effect: { damageMul: 2, fireRateMul: 1.1 } },
        { name: 'Extinction Arrow', cost: 7200, desc: 'The arrow that ends bloodlines — nothing survives its wound.', effect: { damageMul: 2.6 } },
      ],
    },
  },
  demeter: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Golden Fields', cost: 2000, desc: 'Fields of pure gold — +110 gold with every harvest.', effect: { incomePerWaveAdd: 110 } },
        { name: 'Elysian Harvest', cost: 6000, desc: 'The blessed fields of Elysium — +180 gold, wave after wave.', effect: { incomePerWaveAdd: 180 } },
      ],
    },
    B: {
      ...
      tiers: [
        ...
        { name: 'Compounding Empire', cost: 2100, desc: 'Wealth breeds wealth — +2×wave more, and climbing.', effect: { incomeWaveScaleAdd: 2 } },
        { name: 'Hoard of Plutus', cost: 6400, desc: 'The god of riches empties his hoard — +3×wave more, a late-game fortune.', effect: { incomeWaveScaleAdd: 3 } },
      ],
    },
  },
  hermes: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Sky Marshal', cost: 2000, desc: 'Total air command — his recon sweep leaves nowhere to hide.', effect: { rangeMul: 1.2, damageMul: 1.5 } },
        { name: 'Zephyr Ascendant', cost: 6400, desc: 'The west wind made war — an unrelenting storm of steel from above.', effect: { rangeMul: 1.25, damageMul: 1.7 } },
      ],
    },
    B: {
      name: "Hermes' Escort",
      ...
      tiers: [
        ...
        { name: 'Fusillade', cost: 2000, desc: 'A ceaseless fusillade — the lane vanishes behind a wall of darts.', effect: { fireRateMul: 1.5, damageMul: 1.3 } },
        { name: 'Tempest of Blades', cost: 6200, desc: 'A hurricane of steel — the chokepoint is simply erased.', effect: { fireRateMul: 1.6, damageMul: 1.5 } },
      ],
    },
  },
  hephaestus: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Adamant Field', cost: 2100, desc: 'A field of unbreakable barbs — savage hits, a vast reserve (+14).', effect: { damageMul: 1.8, maxChargesAdd: 14 } },
        { name: 'Tartarean Bulwark', cost: 6400, desc: 'The floor of Tartarus itself bristles — merciless and endless (+20).', effect: { damageMul: 2, maxChargesAdd: 20 } },
      ],
    },
    B: {
      ...
      tiers: [
        ...
        { name: 'War Foundry', cost: 2100, desc: 'The war-foundry never cools — spikes faster, and they bite deeper.', effect: { fireRateMul: 1.6, damageMul: 1.4 } },
        { name: 'Cyclopean Assembly', cost: 6400, desc: 'A hundred Cyclopes at the anvil — a flood of ruin under the path.', effect: { fireRateMul: 1.7, damageMul: 1.6 } },
      ],
    },
  },
  poseidon: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Tidal Wrath', cost: 2400, desc: 'A wall of ocean crashes down — wider, harder, and hurling foes back.', effect: { splashRadiusMul: 1.3, knockbackMul: 1.3, damageMul: 1.4 } },
        { name: 'Abyssal Deluge', cost: 8000, desc: 'The abyss rises to swallow the lane — total, sweeping devastation.', effect: { splashRadiusMul: 1.35, knockbackMul: 1.4, damageMul: 1.6 } },
      ],
    },
    B: {
      name: 'Maelstrom',
      ...
      tiers: [
        ...
        { name: 'Leviathan\'s Maw', cost: 2400, desc: 'The leviathan surfaces — jaws that crush the greatest hulls.', effect: { damageMul: 2, fireRateMul: 1.2 } },
        { name: 'Wrath of Atlantis', cost: 8400, desc: 'The drowned kingdom answers — an unending barrage from the deep.', effect: { damageMul: 2.6, fireRateMul: 1.3 } },
      ],
    },
  },
  aphrodite: {
    A: {
      ...
      tiers: [
        ...
        { name: 'Beloved of All', cost: 1800, desc: 'The whole lane swoons — 5 more foes held in a wider field.', effect: { rangeMul: 1.2, slowTargetsAdd: 5 } },
        { name: 'Heart of the World', cost: 5600, desc: 'Love that moves the world — 7 more charmed across a vast reach.', effect: { rangeMul: 1.25, slowTargetsAdd: 7 } },
      ],
    },
    B: {
      ...
      tiers: [
        ...
        { name: 'Deep Freeze', cost: 2000, desc: 'The cold bites to the bone — a near-total stop, reaching farther.', effect: { slowMulMul: 0.5, rangeMul: 1.1 } },
        { name: 'Absolute Zero', cost: 6000, desc: 'All warmth flees — the charmed stand as statues of frost.', effect: { slowMulMul: 0.4, rangeMul: 1.15 } },
      ],
    },
  },
  athena: {
    A: {
      ...
      tiers: [
        ...
        { name: 'War Council', cost: 2100, desc: 'The full council convenes — every blade in the aura bites deeper.', effect: { damageMul: 1.35 } },
        { name: 'Divine Mandate', cost: 6400, desc: 'Athena\'s own mandate — the war-council fights with a god\'s edge.', effect: { damageMul: 1.4 } },
      ],
    },
    B: {
      name: 'Strategist',
      ...
      tiers: [
        ...
        { name: 'Grand Watch', cost: 2000, desc: 'Watchfires ring the field — a vast aura, quicker to strike.', effect: { rangeMul: 1.25, fireRateMul: 1.2 } },
        { name: 'Omniscience', cost: 6000, desc: 'Nothing escapes the Owl — the widest, sharpest command on the map.', effect: { rangeMul: 1.3, fireRateMul: 1.25 } },
      ],
    },
  },
}
